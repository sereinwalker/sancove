...
从 [Releases](https://github.com/sereinwalker/sancove/releases) 下载对应系统的 ZIP 包，解压运行：
...
| 平台 | 下载包 | 说明 |
|------|--------|------|
| Windows | `sancove-windows-msvc.zip` | 10/11 64位，双击 `sancove.exe` 直接启动 |
| Linux   | `sancove-linux-x64.zip`    | x86-64，需 GTK3 运行时 |
| macOS   | `sancove-macos-x64.zip`    | Intel，macOS 12+ |
...
需要 [Rust 工具链](https://rustup.rs/)（1.75+）。支持 Windows / Linux / macOS 原生编译。
...
> **Linux 编译注意：** 需安装 GTK3 开发库：`sudo apt install libgtk-3-dev libxdo-dev`
